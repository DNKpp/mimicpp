...
if (NOT TARGET enable-config-options)
	...
	OPTION(MIMICPP_CONFIG_MINIMAL_PRETTY_TYPE_PRINTING "Minimizes the work done during type-printing." OFF)
	message(DEBUG "${MESSAGE_PREFIX} MIMICPP_CONFIG_MINIMAL_PRETTY_TYPE_PRINTING: ${MIMICPP_CONFIG_MINIMAL_PRETTY_TYPE_PRINTING}")
	...
	target_compile_definitions(
		...
		INTERFACE
		$<$<BOOL:${MIMICPP_CONFIG_MINIMAL_PRETTY_TYPE_PRINTING}>:MIMICPP_CONFIG_MINIMAL_PRETTY_TYPE_PRINTING>
