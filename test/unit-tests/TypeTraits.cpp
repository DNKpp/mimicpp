...
TEMPLATE_TEST_CASE_SIG(
	...
	"[type_traits]",
	((bool dummy, typename T, typename Char, typename String, typename View), dummy, T, Char, String, View),
	(true, char*, char, std::string, std::string_view),
	(true, const char*, char, std::string, std::string_view),
	(true, wchar_t*, wchar_t, std::wstring, std::wstring_view),
	(true, const wchar_t*, wchar_t, std::wstring, std::wstring_view),
	(true, char8_t*, char8_t, std::u8string, std::u8string_view),
	(true, const char8_t*, char8_t, std::u8string, std::u8string_view),
	(true, char16_t*, char16_t, std::u16string, std::u16string_view),
	(true, const char16_t*, char16_t, std::u16string, std::u16string_view),
	(true, char32_t*, char32_t, std::u32string, std::u32string_view),
	(true, const char32_t*, char32_t, std::u32string, std::u32string_view),

	(true, std::string, char, std::string, std::string_view),
	(true, std::wstring, wchar_t, std::wstring, std::wstring_view),
	(true, std::u8string, char8_t, std::u8string, std::u8string_view),
	(true, std::u16string, char16_t, std::u16string, std::u16string_view),
	(true, std::u32string, char32_t, std::u32string, std::u32string_view),

	(true, std::string_view, char, std::string, std::string_view),
	(true, std::wstring_view, wchar_t, std::wstring, std::wstring_view),
	(true, std::u8string_view, char8_t, std::u8string, std::u8string_view),
	(true, std::u16string_view, char16_t, std::u16string, std::u16string_view),
	(true, std::u32string_view, char32_t, std::u32string, std::u32string_view)
)
{
	...
	STATIC_REQUIRE(std::same_as<View, typename traits_t::view_t>);

	STATIC_REQUIRE(
		requires(const T& str)
		{
		{traits_t{}.to_string(str)} -> std::same_as<String>;
		{traits_t{}.to_view(str)} -> std::same_as<View>;
		});
}
