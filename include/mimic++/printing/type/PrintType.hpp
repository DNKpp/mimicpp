...
MIMICPP_DETAIL_MODULE_EXPORT namespace mimicpp::printing::type
{
    ...
    /**
     * \brief Returns the raw type-name.
     * \ingroup PRINTING_TYPE
     * \tparam T The desired type.
     * \return The raw name.
     * \details
     * This function internally relies on `std::source_location::function_name`
     * and tries to extract the desired type-name from that function-name.
     */
    template <typename T>
    [[nodiscard]]
    ...
    /**
     * \brief Prettifies a typen-name.
     * \ingroup PRINTING_TYPE
     * \tparam OutIter The print-iterator type.
     * \param out The print iterator.
     * \param name The name to be prettified.
...
MIMICPP_DETAIL_MODULE_EXPORT namespace mimicpp
{
     ...
     * \ingroup PRINTING
     * \brief Type stringification occurs when an object's type is transformed into a textual representation.
     ...
     * Users can create a specialization of  `mimicpp::custom::TypePrinter` for their type, which will then be prioritized over the internal conversions.
     *
