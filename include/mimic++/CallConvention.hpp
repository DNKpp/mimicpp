...
#define MIMICPP_DETAIL_DEFINE_CALL_CONVENTION_CALL_INTERFACE(call_convention, constness, category, qualifications) \
    ...
    {                                                                                                              \
    public:                                                                                                        \
        constexpr ::mimicpp::signature_return_type_t<Signature> call_convention operator()(                        \
            Params... params,                                                                                      \
            const ::std::source_location& from = ::std::source_location::current()) qualifications                 \
            noexcept(::mimicpp::signature_is_noexcept_v<Signature>)                                                \
        {                                                                                                          \
...
#define MIMICPP_REGISTER_CALL_CONVENTION(call_convention, namespace_name)                                                           \
    ...
    {                                                                                                                               \
        ...
        template <                                                                                                                  \
            typename Derived,                                                                                                       \
            typename Signature,                                                                                                     \
            Constness constQualifier = ::mimicpp::signature_const_qualification_v<Signature>,                                       \
            ValueCategory refQualifier = ::mimicpp::signature_ref_qualification_v<Signature>,                                       \
            typename ParamList = ::mimicpp::signature_param_list_t<Signature>>                                                      \
        class CallInterface;                                                                                                        \
                                                                                                                                    \
        MIMICPP_DETAIL_DEFINE_CALL_CONVENTION_CALL_INTERFACE(call_convention, Constness::non_const, ValueCategory::any, );          \
        MIMICPP_DETAIL_DEFINE_CALL_CONVENTION_CALL_INTERFACE(call_convention, Constness::as_const, ValueCategory::any, const);      \
        MIMICPP_DETAIL_DEFINE_CALL_CONVENTION_CALL_INTERFACE(call_convention, Constness::non_const, ValueCategory::lvalue, &);      \
        MIMICPP_DETAIL_DEFINE_CALL_CONVENTION_CALL_INTERFACE(call_convention, Constness::as_const, ValueCategory::lvalue, const&);  \
        MIMICPP_DETAIL_DEFINE_CALL_CONVENTION_CALL_INTERFACE(call_convention, Constness::non_const, ValueCategory::rvalue, &&);     \
        MIMICPP_DETAIL_DEFINE_CALL_CONVENTION_CALL_INTERFACE(call_convention, Constness::as_const, ValueCategory::rvalue, const&&); \
    }                                                                                                                               \
                                                                                                                                    \
