...
#ifndef MIMICPP_UTILITIES_STACKTRACE_HPP
#define MIMICPP_UTILITIES_STACKTRACE_HPP
...
namespace mimicpp::util::stacktrace::detail
{
    ...
    constexpr OutIter print_entry(OutIter out, Stacktrace const& stacktrace, std::size_t const index)
    {
        ...
        return printing::detail::print_source_location(
            std::move(out),
            stacktrace.source_file(index),
